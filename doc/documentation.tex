...
The main interpreter loop extracts the character at the PC's position from the array and terminates if it is an \code{@}-character and string mode (see \ref{sec:stringmode}) is disabled. Otherwise, one of two things happen:

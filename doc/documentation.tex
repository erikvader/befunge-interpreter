...
\code{"egnufeB">:\#v\_@}\\
\code{\hspace{3.5em}\^{} ,<}
\caption{Printing a string in Befunge. The program prints \code{Befunge}. Note that the string is pushed reversely onto the stack and that the program ends when .}
\label{fig:print}
\end{figure}
...
% Cell size: 2 bytes instead of 1
